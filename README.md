...
:heavy_check_mark: Для часто создающихся объектов использую **Pool Object**

:heavy_check_mark: ~~Игровые менеджеры с помощью **Singleton**~~ Постепенно переделываю архитектуру проект с использованием **Zenject**, тем самым исбавляюсь от **Singleton**-ов

:heavy_check_mark: Игровые объекты взаимодействуют с друг другом с помощью системы событий с использованием **UnityEvent** (т.е. в неком виде паттерн **Observer**)
...
:heavy_check_mark: Модели юнитов юнитов и окружения приобретены в **AssetStore**
...
+ Переделать проект с использованием DI (**Zenject**)
