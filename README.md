...
:heavy_check_mark: ~~Игровые менеджеры с помощью **Singleton**~~ Постепенно переделываю архитектуру проекта с использованием **Zenject**, тем самым избавляюсь от **Singleton**-ов
...
:heavy_check_mark: Модели юнитов и окружения приобретены в **AssetStore**
